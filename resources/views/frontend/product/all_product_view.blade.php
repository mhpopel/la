                    ...
                    <div class="fld inline">
                        <div class="dropdown dropdown-small dropdown-med dropdown-white inline">
                            ...
                            <ul role="menu" class="dropdown-menu">
                              <li role="presentation"><a href="{{ url('products/Lowest first') }}">Price:Lowest first</a></li>
                              <li role="presentation"><a href="{{ url('products/Highest first') }}">Price:HIghest first</a></li>
                              <li role="presentation"><a href="{{ url('products/A to Z') }}">Product Name:A to Z</a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- /.fld -->
